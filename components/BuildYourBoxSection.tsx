...
export default function BuildYourBoxSection() {
  ...
  return (
    <section id="build-your-box" className="scroll-mt-24 py-16 md:py-20">
      <div className="mx-auto max-w-6xl px-6">
        <div className="overflow-hidden rounded-3xl bg-biggs-green md:grid md:grid-cols-2 md:items-center">
          ...
          <div className="flex flex-col justify-center px-6 py-8 sm:px-8 md:px-10 md:py-10">
            ...
            <h2 className="mt-2 font-display text-3xl font-bold leading-tight text-biggs-cream md:text-4xl">
              {product.title}
            </h2>
            <p className="mt-2 text-xl font-semibold text-biggs-yellow">
              £{product.price.toFixed(2)}
            </p>
            <p className="text-xs font-semibold text-biggs-yellow/80">
              (inc Free Delivery across the UK)
            </p>
